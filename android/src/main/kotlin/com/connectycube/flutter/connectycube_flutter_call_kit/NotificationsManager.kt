...
fun showCallNotification(
    ...
    val ringtone: Uri =
        RingtoneManager.getActualDefaultRingtoneUri(context.applicationContext, RingtoneManager.TYPE_RINGTONE)
...
fun addCallRejectAction(
    context: Context, notificationBuilder: Notification.Builder,
...
fun addCallFullScreenIntent(
    ...
    val callFullScreenIntent: Intent =
        createStartIncomingScreenIntent(context, callId, callType, callInitiatorId, callInitiatorName, callOpponents)
